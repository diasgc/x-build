...
on_start(){
	$host_mingw && cmake_config+=" -DCMAKE_TOOLCHAIN_FILE=${dir_src}/cmake/toolschains/ubuntu1804-mingw64.cmake -DEXIV2_ENABLE_WIN_UNICODE=ON"
	! $build_shared && cmake_config+=" -DEXIV2_ENABLE_DYNAMIC_RUNTIME=OFF" || cmake_config+=" -DEXIV2_ENABLE_DYNAMIC_RUNTIME=ON"

	cmake_config+=" -DINSTALL_EXAMPLES=OFF \
